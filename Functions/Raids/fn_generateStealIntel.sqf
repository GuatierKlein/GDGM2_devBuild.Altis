...
private _desc = ([daytime, "HH:MM"] call BIS_fnc_timeToString) + ", " + str _attackingSide + " commander wants you to steal important documents in " + (_node getVariable "GDGM_name") + ". This objective will be available during 1 hour. The documents look like a briefcase.";
...
[_node, _taskId, _attackingSide] spawn GDGM_fnc_spawnStealIntel; 
