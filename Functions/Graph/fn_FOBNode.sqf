...
private _text = _nearestNode getVariable "GDGM_name";
private _weight = 0.75;
private _targetGarrison = GDGM_smallTownGarri;
...
_node setVariable ["GDGM_name", _text + " FOB"];
...
_node setVariable ["GDGM_type","fob"];
...
_trg setTriggerStatements ["(this && [thisTrigger, thisList] call GDGM_fnc_spawnNodeCondition) || [thisTrigger, thisList] call GDGM_fnc_spawnNodeConditionPrio", "
	if (isServer) then {[thisTrigger getVariable 'GDGM_installation'] spawn GDGM_fnc_spawnFOBNode};
", "
