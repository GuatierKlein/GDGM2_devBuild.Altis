...
//create task
private _title = "Fighter mission: Bomber squadron";
private _desc = ([daytime, "HH:MM"] call BIS_fnc_timeToString) + ", " + ([_ennemySide] call GDGM_fnc_getFactionName) + " has bombers circling around " + (_node getVariable "GDGM_name") + ", destroy them! (This mission is for pilots)";
...
[_ennemySide, -10] spawn GDGM_fnc_addPoints;
